...
{
    public partial class FrmLabelPrintNew_R : MetroForm
    {
        #region Properties
        ...
        private void FrmLabelPrintNew_R_FormClosed(object sender, FormClosedEventArgs e)
        {
            DeviceRemove();
        }
        ...
        public DataTable GetLableData(string UPCCode)
        {
            ...
            try
            {
                ...
                foreach (var item in i)
                {
                    ...
                    dr["UpdatedDate"] = date.ToString("dd MMMM");
        ...
        public void LoadRDLC(string searchStr)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    // Commented Code By Vishal Start
