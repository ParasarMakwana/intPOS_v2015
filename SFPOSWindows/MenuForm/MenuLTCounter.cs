...
namespace SFPOSWindows.MenuForm
{
    ...
    public partial class MenuLTCounter : Form
    {
        ...
        public MenuLTCounter()
        {
            InitializeComponent();
        }

        private void MenuLTCounter_Load(object sender, EventArgs e)
        {
            GenrateTicketScreen();
        }
        ...
        {
            MenuLiveCounter objMenuLiveCounter = new MenuLiveCounter();
            objMenuLiveCounter.Show();
        }
