...
{
    public partial class POCrystalReport : Form
    {
        ...
        private void POCrystalReport_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Application.StartupPath + "\\CrystalRptPOHeaderLine.rpt");
        ...
        public DataTable InvoiceDetailSP(long PONumber)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                dt.Columns.Add(InvoiceDetails_ResultModelCont.Quantity, typeof(decimal));        //Quantity
